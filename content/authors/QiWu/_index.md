...
redirect_url: "https://scholar.google.co.uk/citations?user=aKXe1FEAAAAJ"
...
#     year: 2015
#   - course: MSc in Global Computing and Media Technology
#     institution: University of Bath, UK
#     year: 2011
...
- icon: envelope
  icon_pack: fas
  link: 'mailto:qi.wu01@adelaide.edu.au'  # For a direct email link, use "mailto:test@example.org".
#- icon: twitter
#  icon_pack: fab
#  link: https://twitter.com/GeorgeCushen
- icon: google-scholar
  icon_pack: ai
  link: https://scholar.google.co.uk/citations?user=aKXe1FEAAAAJ

# - icon: home
#   icon_pack: fas
#   link: http://www.qi-wu.me/
#- icon: github
#  icon_pack: fab
