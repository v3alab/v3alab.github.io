...
education:
  ...
  - course: BEng in Internet of Things
    institution: Jiangxi Normal University, China
    year: 2017
...
- icon: envelope
  icon_pack: fas
  link: 'xinyu.wang02@adelaide.edu.au'  # For a direct email link, use "mailto:test@example.org".
